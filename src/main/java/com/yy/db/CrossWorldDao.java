...
public class CrossWorldDao<T> extends DBDao {
   @DBColumnAnno(
      isPrimary = true,
      comment = "编号"
   )
   ...
   public void loadData(String data) {
      GameDefine.CrossWorldModule module = null;

      for(GameDefine.CrossWorldModule worldModule : GameDefine.CrossWorldModule.values()) {
      ...
      if (module == null) {
         throw new RuntimeException("未知world信息类,请检查GameDefine.CrossWorldModule");
      } else {
