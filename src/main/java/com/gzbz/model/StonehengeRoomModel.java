...
public class StonehengeRoomModel extends BaseModel {
   @ModelColumnAnno(
      isPrimaty = true
   )
   private int id;
   ...
   private final List<Integer> relatedRoom = new ArrayList();
   @ModelColumnAnno(
      comment = "事件类型"
   )
   ...
   public List<Integer> getMoveRoom() {
      ArrayList<Integer> list = new ArrayList(this.relatedRoom);
