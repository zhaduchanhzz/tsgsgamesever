...
public class WarriorsExtraModel extends BaseModel {
   @ModelColumnAnno(
      columnName = "id",
      comment = "ID"
   )
   ...
   @ModelColumnAnno(
      columnName = "percentproperties",
      comment = "百分比属性"
   )
   private String percentproperties;

   public WarriorsExtraModel() {
   }

   public WarriorsExtraModel(int id, String skills, String properties) {
      this.id = id;
      this.skills = skills;
