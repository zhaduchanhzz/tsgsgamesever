...
@ModelAnno(
   file = "heroImproveGiftLib"
)
public class HeroImproveGiftLibModel extends BaseModel {
   @ModelColumnAnno(
      isPrimaty = true,
      comment = "序号"
   )
   ...
   public static void loadCustom(ModelPool pool, ConcurrentHashMap<?, ?> map) {
      ConcurrentHashMap<Integer, ConcurrentHashMap<Integer, HeroImproveGiftLibModel>> tempMap = new ConcurrentHashMap();
      ...
      pool.putMap("customHeroImproveGiftLib", tempMap);
   }
