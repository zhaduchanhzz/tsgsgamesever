...
@ModelAnno(
   file = "ZhongqiuBanquet"
)
public class MidAutumnBanquetModel extends BaseModel {
   @ModelColumnAnno(
      isPrimaty = true
   )
   private int id;
   @ModelColumnAnno(
      comment = "月饼id",
      columnName = "moncakeId"
   )
   private int moonCakeId;
   @ModelColumnAnno(
      comment = "刷出概率",
      columnName = "Value"
   )
   ...
   public int getMoonCakeId() {
      return this.moonCakeId;
   }

   public void setMoonCakeId(int moonCakeId) {
      this.checkModify();
      this.moonCakeId = moonCakeId;
   }
