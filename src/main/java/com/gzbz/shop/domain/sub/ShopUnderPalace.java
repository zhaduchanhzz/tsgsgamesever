...
public class ShopUnderPalace extends AbstractShop {
   public ShopUnderPalace(GamePlayer player) {
      super(player);
   }

   public String getExcelName() {
      return "shopUnderPalace";
   }
   ...
   public boolean buyItem(int id, int num) {
      ...
      int stageSum = underPalacePart.getStageSum();
      if (model.getLvLimit() > stageSum) {
         return this.player.failure(58004);
      } else {
