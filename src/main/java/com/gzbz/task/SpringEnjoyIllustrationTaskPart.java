...
public class SpringEnjoyIllustrationTaskPart extends AbstractActivityTaskPart {
   ...
   public void sendTaskList(List<TaskData> taskDataList) {
      if (taskDataList != null && !taskDataList.isEmpty()) {
         ThemeActivityMsg.S2C_IllustrationTasksNotify_12906.Builder msg = ThemeActivityMsg.S2C_IllustrationTasksNotify_12906.newBuilder();
   ...
   public TaskDefine.TaskModule getModule() {
      return TaskDefine.TaskModule.MODULE_SPRING_ENJOY_ILLUSTRATION;
   }

   protected void sendCommitTaskResult(int taskId, long completeTime) {
      ThemeActivityMsg.S2C_IllustrationTaskCommit_12904.Builder resp = ThemeActivityMsg.S2C_IllustrationTaskCommit_12904.newBuilder();
