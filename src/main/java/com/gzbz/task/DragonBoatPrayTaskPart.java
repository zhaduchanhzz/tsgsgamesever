...
public class DragonBoatPrayTaskPart extends AbstractActivityTaskPart {
   ...
   public void sendTaskList(List<TaskData> taskDataList) {
      if (taskDataList != null && !taskDataList.isEmpty()) {
         DragonBoatMsg.S2C_DragonBoatPrayTaskNotify_14026.Builder msg = DragonBoatMsg.S2C_DragonBoatPrayTaskNotify_14026.newBuilder();
   ...
   public TaskDefine.TaskModule getModule() {
      return TaskDefine.TaskModule.MODULE_DRAGON_BOAT_PRAY_TASK;
   }
