...
public class SpringEnjoyPrayTaskPart extends AbstractActivityTaskPart {
   ...
   public void trigger() {
      if (!this.isServerActivityInvalid()) {
         ...
         Map<Integer, SpringPrayersModel> springPrayersModelMap = ApplicationContextProvider.<Integer, SpringPrayersModel>getModelPoolMap("springprayers");
         List<TaskData> taskList = new ArrayList();

         for(SpringPrayersModel springPrayersModel : springPrayersModelMap.values()) {
   ...
   public void sendTaskList(List<TaskData> taskDataList) {
      if (taskDataList != null && !taskDataList.isEmpty()) {
         ThemeActivityMsg.S2C_SpringEnjoyPrayTaskNotify_12926.Builder msg = ThemeActivityMsg.S2C_SpringEnjoyPrayTaskNotify_12926.newBuilder();
   ...
   public TaskDefine.TaskModule getModule() {
      return TaskDefine.TaskModule.MODULE_SPRING_ENJOY_PRAY;
   }
