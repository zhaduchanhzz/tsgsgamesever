...
public class ActivityXdmzTaskPart extends AbstractActivityTaskPart {
   public void trigger() {
   ...
   public void sendTaskList(List<TaskData> taskDataList) {
      RotateActivityMsg.S2C_XdmzNotify_16136.Builder msg = RotateActivityMsg.S2C_XdmzNotify_16136.newBuilder();
   ...
   public TaskDefine.TaskModule getModule() {
      return TaskDefine.TaskModule.MODULE_XDMZ;
   }
   ...
   protected void sendCommitTaskResult(int taskId, long completeTime) {
      ...
      RotateActivityMsg.S2C_XdmzCommitTask_16134.Builder resp = RotateActivityMsg.S2C_XdmzCommitTask_16134.newBuilder();
   ...
   public void sendInfo() {
      RotateActivityMsg.S2C_Xdmz_16128.Builder msg = RotateActivityMsg.S2C_Xdmz_16128.newBuilder();
