...
public class ActivityZhangFeiTaskPart extends AbstractActivityTaskPart {
   public void sendTaskList(List<TaskData> taskDataList) {
      if (taskDataList != null) {
         ActivityZhangFeiMsg.S2C_TaskModify_17316.Builder builder = ActivityZhangFeiMsg.S2C_TaskModify_17316.newBuilder();
   ...
   public TaskDefine.TaskModule getModule() {
      return TaskDefine.TaskModule.MODULE_ACT_ZHANG_FEI;
   }
      ...
      if (model == null) {
         ...
         if (taskData == null) {
            ...
            if (this.checkCommit(taskId)) {
               ...
               this.player.addResource(resourceModelList, showType, 84, this.rewardReason(), taskId, 0, "");
            }
   ...
   protected void sendCommitTaskResult(int taskId, long completeTime) {
      ActivityZhangFeiMsg.S2C_TaskCommitTask_17314.Builder builder = ActivityZhangFeiMsg.S2C_TaskCommitTask_17314.newBuilder();
