...
public class EastWarTaskPart extends AbstractActivityTaskPart {
   ...
   public void checkResetDaily() {
      ...
      playerActivityDao.eastWarData.dailyReset();
   ...
   @MsgHandlerAnno
   public void C2S_CommitTask_15651(EastWarMsg.C2S_CommitTask_15651 msg, String source) {
      this.commit(msg.getTaskId());
   }

   @MsgHandlerAnno
   public void C2S_EastWarTasks_15653(EastWarMsg.C2S_EastWarTasks_15653 msg, String source) {
      this.taskList();
   }
         ...
         if (activityInfo.end > DateUtil.getIntTime(System.currentTimeMillis())) {
            ...
            if (!CollectionUtils.isEmpty(map)) {
               ...
               for(Map.Entry<Integer, List<EastWarTaskGroupModel>> entry : map.entrySet()) {
                  if (!playerActivityDao.eastWarData.taskGroup.contains(entry.getKey())) {
               ...
               if (!enableGroupIdList.isEmpty()) {
                  ...
                  playerActivityDao.eastWarData.taskGroup.add(groupId);
   ...
   public void sendTaskList(List<TaskData> taskDataList) {
      if (taskDataList != null) {
         EastWarMsg.S2C_UpdateTasks_15656.Builder builder = EastWarMsg.S2C_UpdateTasks_15656.newBuilder();
   ...
   public TaskDefine.TaskModule getModule() {
      return TaskDefine.TaskModule.MODULE_EAST_WAR;
   }
   ...
   public void commit(int taskId) {
      ...
      if (model == null) {
         ...
         if (this.checkCommit(taskId)) {
            ...
            EastWarTaskModel eastWarTaskModel = (EastWarTaskModel)ApplicationContextProvider.getModelPoolEntity("eastWarTask", taskId);
            if (eastWarTaskModel != null) {
               this.player.getOperationMgr().addReceiveAwardNewLog(this.player, 17, 0, "踏浪东征-任务", award, eastWarTaskModel.getTaskName(), 0, 0, 1);
            }
         }
   ...
   protected void sendCommitTaskResult(int taskId, long completeTime) {
      EastWarMsg.S2C_CommitTask_15652.Builder builder = EastWarMsg.S2C_CommitTask_15652.newBuilder();
   ...
   public void taskList() {
      Map<Integer, TaskData> map = this.getTasksMap();
      if (map != null && !map.isEmpty()) {
         EastWarMsg.S2C_EastWarTasks_15654.Builder builder = EastWarMsg.S2C_EastWarTasks_15654.newBuilder();
