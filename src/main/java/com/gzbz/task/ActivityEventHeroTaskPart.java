...
public class ActivityEventHeroTaskPart extends AbstractActivityTaskPart {
   @MsgHandlerAnno
   public void C2S_CommitTask_20941(ActivityEventHeroMsg.C2S_CommitTask_20941 msg, String source) {
   ...
   @MsgHandlerAnno
   public void C2S_ActivityTaskList_20944(ActivityEventHeroMsg.C2S_ActivityTaskList_20944 msg, String source) {
      this.sendHeroTasks();
   }
   ...
   private void sendHeroTasks() {
      if (this.isAdvanceTask()) {
         ...
         ActivityEventHeroMsg.S2C_ActivityTaskList_20945.Builder msg = ActivityEventHeroMsg.S2C_ActivityTaskList_20945.newBuilder();
   ...
   public void sendTaskList(List<TaskData> taskDataList) {
      if (taskDataList != null && this.isAdvanceTask()) {
         ActivityEventHeroMsg.S2C_ActivityTaskNotify_20946.Builder msg = ActivityEventHeroMsg.S2C_ActivityTaskNotify_20946.newBuilder();
   ...
   public TaskDefine.TaskModule getModule() {
      return TaskDefine.TaskModule.MODULE_EVENT_HERO_ACTIVITY;
   }

   protected void sendCommitTaskResult(int taskId, long completeTime) {
      ActivityEventHeroMsg.S2C_CommitTask_20942.Builder msg = ActivityEventHeroMsg.S2C_CommitTask_20942.newBuilder();
   ...
   private boolean isAdvanceTask() {
      ActivityEventHeroPart part = (ActivityEventHeroPart)this.player.getMgrPart(ActivityEventHeroPart.class);
