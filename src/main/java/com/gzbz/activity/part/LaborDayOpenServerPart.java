...
public class LaborDayOpenServerPart extends AbstractActivityPart {
   @Autowired
   RankMgr rankMgr;
   @Autowired
   WorldMgr worldMgr;
   ...
   @MsgHandlerAnno
   public void C2S_LaborOpenServerRank_13557(GreenPlumMsg.C2S_LaborOpenServerRank_13557 msg, String source) {
      this.sendInfo();
   }

   public void sendInfo() {
      GreenPlumMsg.S2C_LaborOpenServerRank_13558.Builder resp = GreenPlumMsg.S2C_LaborOpenServerRank_13558.newBuilder();
