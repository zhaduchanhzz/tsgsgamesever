...
public class BeautyTreasurePart extends AbstractActivityPart {
   static Logger logger = LoggerFactory.getLogger(BeautyTreasurePart.class);
   @Autowired
   ...
   @MsgHandlerAnno
   public void C2S_BeautyTreasureInfo_5301(BeautyTreasureMsg.C2S_BeautyTreasureInfo_5301 msg, String source) {
      this.sendInfo();
   }
   ...
   public void sendInfo() {
      if (!this.isServerActivityInvalid()) {
         ...
         BeautyTreasureMsg.S2C_BeautyTreasureInfo_5302.Builder builder = BeautyTreasureMsg.S2C_BeautyTreasureInfo_5302.newBuilder();
         builder.setStage(playerActivityDao.beautyTreasure.stage);
         ...
         for(BeautyTreasureRecord treasureRecord : playerActivityDao.beautyTreasure.recordList) {
            BeautyTreasureMsg.RecruitRecord.Builder record = BeautyTreasureMsg.RecruitRecord.newBuilder();
            record.setRecruitType(treasureRecord.recruitType);
         ...
         for(Map.Entry<Integer, Integer> entry : playerActivityDao.beautyTreasure.receiveRecord.entrySet()) {
         ...
         if (playerActivityDao.beautyTreasure.historyRecord.containsKey(1) && ((Map)playerActivityDao.beautyTreasure.historyRecord.get(1)).containsKey(1)) {
            builder.setHighRecruitNum((Integer)((Map)playerActivityDao.beautyTreasure.historyRecord.get(1)).get(1));
         }

         if (playerActivityDao.beautyTreasure.historyRecord.containsKey(2) && ((Map)playerActivityDao.beautyTreasure.historyRecord.get(2)).containsKey(1)) {
            builder.setCommonRecruitNum((Integer)((Map)playerActivityDao.beautyTreasure.historyRecord.get(2)).get(1));
         }

         PlayerResetCustomCache playerResetCustomCache = (PlayerResetCustomCache)this.player.getCustomCache("tb_player_reset", this.player.getPlayerId());
         int dailyCommonDrawNum = (Integer)playerResetCustomCache.getDailyNum(20, 0);
         int dailyHighDrawNum = (Integer)playerResetCustomCache.getDailyNum(21, 0);
         builder.setCommonDrawNum(dailyCommonDrawNum);
         builder.setHighDrawNum(dailyHighDrawNum);
         int freeTimes = (Integer)playerResetCustomCache.getDailyNum(542, 0);
   ...
   @MsgHandlerAnno
   public void C2S_RecruitResult_5306(BeautyTreasureMsg.C2S_RecruitResult_5306 msg, String source) {
      PlayerActivityDao playerActivityDao = (PlayerActivityDao)this.player.getData("tb_player_activity", this.player.getPlayerId());
      BeautyTreasureMsg.S2C_RecruitResult_5307.Builder builder = BeautyTreasureMsg.S2C_RecruitResult_5307.newBuilder();
   ...
   public void checkStage(PlayerActivityDao playerActivityDao) {
      BeautyMainModel beautyMainModel = (BeautyMainModel)this.player.getGameModelPool().getEntity("beautyMain", 1);
      if (playerActivityDao.beautyTreasure.stage == 1) {
         ...
         if (curTime >= this.getPlayerActivityInfo().start + (Integer)beautyMainModel.getTimes().get(0)) {
            playerActivityDao.beautyTreasure.stage = 2;
         ...
         if (curTime >= this.getPlayerActivityInfo().start + (Integer)beautyMainModel.getTimes().get(0) + (Integer)beautyMainModel.getTimes().get(1)) {
            playerActivityDao.beautyTreasure.stage = 3;
            playerActivityDao.updateOp();
         }
      } else if (playerActivityDao.beautyTreasure.stage == 0) {
         playerActivityDao.beautyTreasure.stage = 1;
         playerActivityDao.updateOp();
      } else if (playerActivityDao.beautyTreasure.stage == 2) {
         int curTime = DateUtil.getIntTime(System.currentTimeMillis());
         if (curTime >= this.getPlayerActivityInfo().start + (Integer)beautyMainModel.getTimes().get(0) + (Integer)beautyMainModel.getTimes().get(1)) {
            playerActivityDao.beautyTreasure.stage = 3;
            playerActivityDao.updateOp();
   ...
   @MsgHandlerAnno
   public void C2S_RecruitBeautyTreasure_5403(BeautyTreasureMsg.C2S_RecruitBeautyTreasure_5303 msg, String source) {
      if (!this.isServerActivityInvalid()) {
         PlayerActivityDao playerActivityDao = (PlayerActivityDao)this.player.getData("tb_player_activity", this.player.getPlayerId());
         this.checkStage(playerActivityDao);
         BeautyTreasureMsg.S2C_RecruitBeautyTreasure_5304.Builder builder = BeautyTreasureMsg.S2C_RecruitBeautyTreasure_5304.newBuilder();
         BeautyTreasureData data = playerActivityDao.beautyTreasure;
         if (data.stage == 3) {
            ...
            if (num != Integer.parseInt(timesStr[0]) && num != Integer.parseInt(timesStr[1]) && num != Integer.parseInt(timesStr[2])) {
               ...
               if (type == 2) {
                  hadDrawNum = (Integer)playerResetCustomCache.getDailyNum(20, 0);
               } else if (type == 1) {
                  hadDrawNum = (Integer)playerResetCustomCache.getDailyNum(21, 0);
               }

               if (hadDrawNum >= lotteryLimit) {
                  this.player.failure(51);
               } else {
                  if (num + hadDrawNum > lotteryLimit) {
                     num = lotteryLimit - hadDrawNum;
                  }
                  ...
                  if (num > 0) {
                     ...
                     if (beautyMainModel != null) {
                        if (beautyMainModel.getActType() != this.getActivityType()) {
                           ...
                           int freeTimes = (Integer)playerResetCustomCache.getDailyNum(542, 0);
                           if ((type != 2 || freeTimes != 0 || num != 1) && !this.player.checkResourceNum((Integer)beautyMainModel.getSpend().get(0), (Integer)beautyMainModel.getSpend().get(1), (Integer)beautyMainModel.getSpend().get(2) * num)) {
                              if (type == 1) {
                              ...
                              if (modelList.isEmpty()) {
                                 ...
                                 playerActivityDao.updateOp();
                                 if (type == 2) {
                                    playerResetCustomCache.addDailyReset(20, num);
                                 } else if (type == 1) {
                                    playerResetCustomCache.addDailyReset(21, num);
                                 }

                                 this.player.addResource(awardList, PlayerMsg.ShowType.SHOW_BEAUTY_TREASURE, 8, 886, 0, 0, "");
                                 if (type == 2 && freeTimes == 0 && num == 1) {
                                    playerResetCustomCache.addDailyReset(542, 1);
                                 } else {
                                 ...
                                 builder.setCommonDrawNum(dailyCommonDrawNum);
                                 builder.setHighDrawNum(dailyHighDrawNum);
                                 int freeFlag = (Integer)playerResetCustomCache.getDailyNum(542, 0);
                                 builder.setFreeRecruit(freeFlag);
                                 this.player.sendMsg(builder.build());
                                 if (!broadcastList.isEmpty()) {
                                    BeautyTreasureMsg.S2S_RecruitRecord_5320.Builder crossBuilder = BeautyTreasureMsg.S2S_RecruitRecord_5320.newBuilder();

                                    for(Integer id : broadcastList) {
                                       if (modelMap.containsKey(id)) {
                                          BeautyTreasureModel model = (BeautyTreasureModel)modelMap.get(id);
                                          BeautyTreasureMsg.RecruitRecord.Builder recordBuilder = BeautyTreasureMsg.RecruitRecord.newBuilder();
                                 ...
                                 for(ResourceModel resourceModel : awardList) {
                                    ...
                                    this.player.getOperationMgr().addExtraLog(this.player, 198, "红颜探宝", itemId + "", realNum + "", strings[0], strings[2], strings[1], "0");
                                 }
   ...
   public void rotateReset(int oldActivityId) {
      ...
      shopPart.resetShopById(32);
      this.clearActivityGift(24);
   }

   public void resetData() {
      PlayerActivityDao playerActivityDao = (PlayerActivityDao)this.player.getData("tb_player_activity", this.player.getPlayerId());
      playerActivityDao.beautyTreasure.recordList.clear();
      playerActivityDao.beautyTreasure.receiveRecord.clear();
      playerActivityDao.beautyTreasure.historyRecord.clear();
      playerActivityDao.beautyTreasure.stage = 1;
      playerActivityDao.updateOp();
   }
   ...
   public void test() {
      BeautyTreasureMsg.C2S_RecruitBeautyTreasure_5303.Builder aa = BeautyTreasureMsg.C2S_RecruitBeautyTreasure_5303.newBuilder();
      aa.setStage(2);
      aa.setRecruitType(1);
      aa.setRecruitNum(10);
      this.C2S_RecruitBeautyTreasure_5403(aa.build(), "");
   }
}
