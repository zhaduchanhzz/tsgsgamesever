...
import com.gzbz.task.ActivityZzrzTaskPart;
...
public class ZzrzActivityPart extends AbstractActivityPart {
   @MsgHandlerAnno
   public void C2S_WarLog_16115(RotateActivityMsg.C2S_WarLog_16115 msg, String source) {
      this.sendInfo();
   }

   @MsgHandlerAnno
   public void C2S_WarLogCommitTask_16121(RotateActivityMsg.C2S_WarLogCommitTask_16121 msg, String source) {
      int taskId = msg.getTaskId();
      ActivityZzrzTaskPart activityZzrzTaskPart = (ActivityZzrzTaskPart)this.player.getMgrPart(ActivityZzrzTaskPart.class);
      activityZzrzTaskPart.commit(taskId);
   }

   @MsgHandlerAnno
   public void C2S_WarLogBoxReward_16117(RotateActivityMsg.C2S_WarLogBoxReward_16117 msg, String source) {
   ...
   @MsgHandlerAnno
   public void C2S_WarLogRechargeTotalReward_16119(RotateActivityMsg.C2S_WarLogRechargeTotalReward_16119 msg, String source) {
   ...
   @MsgHandlerAnno
   public void C2S_WarLogRechargeTotalInfo_16125(RotateActivityMsg.C2S_WarLogRechargeTotalInfo_16125 msg, String source) {
      this.sendRechargeRewardInfo();
   }

   public void sendInfo() {
      ActivityZzrzTaskPart activityZzrzTaskPart = (ActivityZzrzTaskPart)this.player.getMgrPart(ActivityZzrzTaskPart.class);
      activityZzrzTaskPart.sendInfo();
   }
   ...
   public void rotateReset(int oldActivityId) {
      ...
      taskCustomCache.delete(TaskDefine.TaskModule.MODULE_ZZRZ);
      ActivityRotateSignDao activityRotateSignDao = (ActivityRotateSignDao)this.player.getData("tb_activity_rotate_sign", this.player.getPlayerId());
      ...
      ActivityZzrzTaskPart activityZzrzTaskPart = (ActivityZzrzTaskPart)this.player.getMgrPart(ActivityZzrzTaskPart.class);
      activityZzrzTaskPart.trigger();
   }

   public void resetDaily() {
      ActivityZzrzTaskPart activityZzrzTaskPart = (ActivityZzrzTaskPart)this.player.getMgrPart(ActivityZzrzTaskPart.class);
      activityZzrzTaskPart.clearTasks();
      activityZzrzTaskPart.trigger();
   }
   ...
   private void checkActivityRotateType() {
      ...
      GiftPart giftPart = (GiftPart)this.player.getMgrPart(GiftPart.class);
      RotaingPackagesModel rotaingPackagesModel = giftPart.getRotatePackage(this.getActivityRotateType());
      if (rotaingPackagesModel != null && rotaingPackagesModel.getActivityId() != (Integer)MapUtil.getOrDefault(activityRotateSignDao.activityRotateMap, this.getActivityRotateType(), 0)) {
         activityRotateSignDao.activityRotateMap.put(this.getActivityRotateType(), rotaingPackagesModel.getActivityId());
         activityRotateSignDao.updateOp();
      }
   ...
   private void sendBoxRewardResult(int boxId) {
      RotateActivityMsg.S2C_WarLogBoxReward_16118.Builder msg = RotateActivityMsg.S2C_WarLogBoxReward_16118.newBuilder();
      msg.setBoxId(boxId);
      this.player.sendMsg(msg.build());
   }

   private void sendRechargeRewardResult(int id) {
      RotateActivityMsg.S2C_WarLogRechargeTotalReward_16120.Builder msg = RotateActivityMsg.S2C_WarLogRechargeTotalReward_16120.newBuilder();
      msg.setRewardId(id);
      this.player.sendMsg(msg.build());
   }

   public void sendRechargeRewardInfo() {
      RotateActivityMsg.S2C_WarLogRechargeTotalInfo_16126.Builder resp = RotateActivityMsg.S2C_WarLogRechargeTotalInfo_16126.newBuilder();
      ActivityRotateSignDao activityRotateSignDao = (ActivityRotateSignDao)this.player.getData("tb_activity_rotate_sign", this.player.getPlayerId());
