...
public class KingOfCentralPlainsMgr extends GameMgr {
   ...
   public void runReady(int round) {
      ...
      Map<Integer, GuessData> guessDataMap = (Map)((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(round - 1);
      ...
      switch (round) {
         ...
         case 7:
            for(Map.Entry<Integer, Map<Integer, FightData>> entry : ((KingOfCentralPlainsData)worldDao.jsonData).map_32.entrySet()) {
               for(Map.Entry<Integer, FightData> subEntry : ((Map)entry.getValue()).entrySet()) {
   ...
   public List<FightData> getFightDataList(int round) {
      ...
      switch (round) {
         ...
         case 5:
         case 6:
            fightDataList = (List)((KingOfCentralPlainsData)worldDao.jsonData).map_trial.get(round);
            break;
         case 7:
            for(Map.Entry<Integer, Map<Integer, FightData>> entry : ((KingOfCentralPlainsData)worldDao.jsonData).map_32.entrySet()) {
               for(Map.Entry<Integer, FightData> subEntry : ((Map)entry.getValue()).entrySet()) {
   ...
   public void runSettle(int round) {
      ...
      Map<Integer, GuessData> guessDataMap = (Map)((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(round);
      if (guessDataMap != null) {
   ...
   public void runSendAward() {
      ...
      for(int i = 1; i <= 11; ++i) {
         Map<Integer, GuessData> map = (Map)((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(i);
         if (map != null) {
   ...
   public void initGroup32() {
      ...
      for(int i = 0; i < teamSize; ++i) {
         ...
         if (((KingOfCentralPlainsData)worldDao.jsonData).map_32.get(mapKey) == null) {
            ...
            ((Map)((KingOfCentralPlainsData)worldDao.jsonData).map_32.get(mapKey)).put(subMapKey, fightData);
         }
   ...
   public void initGroup16() {
      ...
      for(Map.Entry<Integer, Map<Integer, FightData>> entry : ((KingOfCentralPlainsData)worldDao.jsonData).map_32.entrySet()) {
         int tempsize = ((Map)entry.getValue()).size() / 2;

         for(int i = 0; i < tempsize; ++i) {
            FightData leftFightData = (FightData)((Map)entry.getValue()).get(2 * i);
            FightData rightFightData = (FightData)((Map)entry.getValue()).get(2 * i + 1);
            ...
            if (((KingOfCentralPlainsData)worldDao.jsonData).map_16.get(entry.getKey()) == null) {
               ...
               ((Map)((KingOfCentralPlainsData)worldDao.jsonData).map_16.get(entry.getKey())).put(i, newFightData);
            }
      ...
      for(Map.Entry<Integer, Map<Integer, FightData>> entry : ((KingOfCentralPlainsData)worldDao.jsonData).map_16.entrySet()) {
         ...
         for(int i = 0; i < tempsize; ++i) {
            ...
            if (((KingOfCentralPlainsData)worldDao.jsonData).map_8.get(entry.getKey()) == null) {
               ...
               ((Map)((KingOfCentralPlainsData)worldDao.jsonData).map_8.get(entry.getKey())).put(i, newFightData);
            }
   ...
   public void S2C_GuessRecordResult_9618(GamePlayer gamePlayer) {
      ...
      for(Map.Entry<Integer, Map<Integer, GuessData>> entry : ((KingOfCentralPlainsData)worldDao.jsonData).guessData.entrySet()) {
         ...
         for(Map.Entry<Integer, GuessData> subEntry : ((Map)entry.getValue()).entrySet()) {
   ...
   public void C2S_GuessRecordAll_9619(GamePlayer gamePlayer) {
      ...
      for(Map.Entry<Integer, FightData> entry : ((KingOfCentralPlainsData)worldDao.jsonData).guessFightDataMap.entrySet()) {
         ...
         Map<Integer, GuessData> tempMap = (Map)((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(round);
   ...
   public void guess(GamePlayer gamePlayer, int wagerSide, int wagerNum) {
      ...
      if (state != 2) {
         ...
         if (wagerNum >= heroRivalGuessChipMin && wagerNum <= heroRivalGuessChipMax) {
            GuessData guessData = (GuessData)((Map)((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(round)).get(gamePlayer.getPlayerId());
            int oldGuessNum = 0;
            if (guessData != null) {
            ...
            if (returnNum >= 0 || gamePlayer.checkResourceNum(resourceModel)) {
               ...
               ((Map)((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(round)).put(gamePlayer.getPlayerId(), guessData);
   ...
   public void S2C_Rank32UiResult_9632(int playerId) {
      ...
      for(Map.Entry<Integer, Map<Integer, FightData>> entry : ((KingOfCentralPlainsData)worldDao.jsonData).map_32.entrySet()) {
         ...
         if (round >= 8 || ((KingOfCentralPlainsData)worldDao.jsonData).activityEnd == 1) {
            for(Map.Entry<Integer, FightData> subEntry : ((Map)((KingOfCentralPlainsData)worldDao.jsonData).map_16.get(group)).entrySet()) {
         ...
         if (round >= 9 || ((KingOfCentralPlainsData)worldDao.jsonData).activityEnd == 1) {
            for(Map.Entry<Integer, FightData> subEntry : ((Map)((KingOfCentralPlainsData)worldDao.jsonData).map_8.get(group)).entrySet()) {
   ...
   public void C2S_PlayerKCPSettle_9661(GamePlayer gamePlayer) {
      ...
      if (((KingOfCentralPlainsData)worldDao.jsonData).state == 2) {
         ...
         for(Map.Entry<Integer, List<FightData>> entry : ((KingOfCentralPlainsData)worldDao.jsonData).map_trial.entrySet()) {
            for(FightData fightData : (List)entry.getValue()) {
   ...
   public void S2C_MyRecordResult_9604(GamePlayer gamePlayer) {
      ...
      if (fightPlayerData == null) {
         ...
         for(int i = 6; i > 0; --i) {
            List<FightData> list = (List)((KingOfCentralPlainsData)worldDao.jsonData).map_trial.get(i);
   ...
   public FightData getFightDataByPlayerId(int round, int playerId) {
      ...
      switch (round) {
         ...
         case 5:
         case 6:
            for(FightData data : (List)((KingOfCentralPlainsData)worldDao.jsonData).map_trial.get(round)) {
   ...
   public void clearPlayerGuessInfo(GamePlayer gamePlayer) {
      ...
      if (((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(round) != null) {
         GuessData guessData = (GuessData)((Map)((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(round)).get(gamePlayer.getPlayerId());
         if (guessData != null) {
            ((Map)((KingOfCentralPlainsData)worldDao.jsonData).guessData.get(round)).remove(gamePlayer.getPlayerId());
         }
