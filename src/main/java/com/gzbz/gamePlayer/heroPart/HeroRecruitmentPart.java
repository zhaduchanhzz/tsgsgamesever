   ...
   public void C2S_HeroRecruitment_5013(HeroMsg.C2S_HeroRecruitment_5013 msg, String source) {
      ...
      switch (type) {
         case COMMON:
            ...
            break;
         case FRIENDLY:
            LanguageModel strModel = (LanguageModel)ApplicationContextProvider.getModelPoolEntity("language", "heroEmployee2");
            recruitmentName = strModel.getValue();
            if (numType == HeroMsg.NumType.ONCE) {
               recruitmentrNum = 1;
               reason = 424;
         ...
         case PROFESSIONAL:
            ...
            break;
         case INTEGRAL:
            LanguageModel strModel = (LanguageModel)ApplicationContextProvider.getModelPoolEntity("language", "heroEmployee4");
            recruitmentName = strModel.getValue();
            recruitmentrNum = 1;
            reason = 428;
            break;
