...
public class ConditionAtkerNationRestrain implements ConditionFunc {
         ...
         if (Objects.isNull(atkerModel)) {
            ...
            if (Objects.isNull(targetEntity)) {
               ...
               if (Objects.isNull(targetModel)) {
                  ...
                  switch (atkerNation) {
                     case 1:
                        return targetNation == 2;
                     case 2:
                        return targetNation == 3;
                     case 3:
                        return targetNation == 1;
                     case 4:
                        return targetNation == 5;
                     case 5:
                        return targetNation == 4;
                     default:
                        return false;
                  }
               }
