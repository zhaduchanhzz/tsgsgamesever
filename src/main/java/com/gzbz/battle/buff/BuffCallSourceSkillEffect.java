...
public class BuffCallSourceSkillEffect extends ListenerBuff {
      ...
      if (buffModel != null) {
         ...
         if (buffUseFun != null) {
            ...
            if (skillEffectModel != null) {
               for(Entity target : this.source.getScene().selectTarget(event.getAction(), this.source, skillEffectModel.getTargetType(), skillEffectModel.getSelectType(), skillEffectModel.getSelectNum(), skillEffectModel.getSelectParam())) {
