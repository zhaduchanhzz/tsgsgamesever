...
public class CheckSkillHurt extends ListenerChecker {
   ...
   boolean check(Event event, ListenerContext context) {
      ...
      switch (context.param) {
         ...
         case 5:
            EntitySkill entitySkill1 = (EntitySkill)event.getParam(5);
            if (entitySkill1 == null) {
               return false;
            } else {
         ...
         case 6:
            EntitySkill entitySkill3 = (EntitySkill)event.getParam(5);
            if (entitySkill3 == null) {
               return false;
            } else {
         ...
         case 7:
            EntitySkill entitySkill2 = (EntitySkill)event.getParam(5);
            if (entitySkill2 == null) {
               return false;
            }

            return context.entity == source && event.getAction().getType() == 4 && entitySkill2.index == 1;
         case 8:
         ...
         case 13:
            for(Entity e : (ArrayList)event.getParam(14)) {
