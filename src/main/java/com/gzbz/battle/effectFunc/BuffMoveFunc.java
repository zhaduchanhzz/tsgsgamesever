...
public class BuffMoveFunc extends EffectFunc {
   ...
   public boolean process(Action action, Entity source, Entity target, List<Entity> targets, SkillEffectModel model, Event event) {
      ...
      if (idMap != null && idMap.size() != 0) {
         ...
         List<Entity> selectTargetList = source.getPkTeam().getTargetSelector().getTargets(action, source, selectType, selectNum, (String)null);
