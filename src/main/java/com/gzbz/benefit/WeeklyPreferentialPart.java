...
public class WeeklyPreferentialPart extends PlayerPart {
   @MsgHandlerAnno
   public void C2S_WeeklyPreferentialInfo_8109(BenefitMsg.C2S_WeeklyPreferentialInfo_8109 msg, String source) {
      this.sendInfo();
   }

   @MsgHandlerAnno
   public void C2S_WeeklyPreferentialBuy_8113(BenefitMsg.C2S_WeeklyPreferentialBuy_8113 msg, String source) {
      int buyId = msg.getBuyId();
      GiftPart giftPart = (GiftPart)this.player.getMgrPart(GiftPart.class);
      int result = giftPart.checkAndBuy(buyId, 0, 20, 2004);
      if (result != 1) {
   ...
   public void sendBuyResult(int buyId) {
      BenefitMsg.S2C_WeeklyPreferentialBuyResult_8114.Builder msg = BenefitMsg.S2C_WeeklyPreferentialBuyResult_8114.newBuilder();
      msg.setBuyId(buyId);
      msg.setResult(1);
      this.player.sendMsg(msg.build());
      LogOperationMgr logOperationMgr = (LogOperationMgr)ApplicationContextProvider.getContext().getBean(LogOperationMgr.class);
      logOperationMgr.pushTask(() -> logOperationMgr.addActivityLog(this.player, 1310, "每周特惠"));
   }

   public void sendInfo() {
      BenefitMsg.S2C_WeeklyPreferentialResult_8110.Builder resp = BenefitMsg.S2C_WeeklyPreferentialResult_8110.newBuilder();
      GiftPart giftPart = (GiftPart)this.player.getMgrPart(GiftPart.class);
      PlayerBenefitExtend playerBenefitExtend = (PlayerBenefitExtend)this.player.getPlayerExtend(20);
      Map<Integer, GiftDao> giftDaoMap = giftPart.getBuyGifts(3);
      TreeMap<Integer, ShopLimitModel> shopLimitModels = giftPart.getShopLimits(3, playerBenefitExtend.weeklyPreferentialRotate);
   ...
   public void checkRotate(boolean needSend) {
      GiftPart giftPart = (GiftPart)this.player.getMgrPart(GiftPart.class);
      RotaingPackagesModel rotaingPackagesModel = giftPart.getRotatePackage(3);
      PlayerBenefitExtend playerBenefitExtend = (PlayerBenefitExtend)this.player.getPlayerExtend(20);
      if (rotaingPackagesModel != null && playerBenefitExtend.weeklyPreferentialRotate != rotaingPackagesModel.getActivityId()) {
         playerBenefitExtend.weeklyPreferentialRotate = rotaingPackagesModel.getActivityId();
