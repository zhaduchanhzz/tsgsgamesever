...
@DBTableAnno(
   name = "tb_activity_yuan_dan",
   resultType = 0,
   selectKey = {"playerId"}
)
public class ActivityYuanDanDao extends AddUpAndConBaseDao {
   @DBColumnAnno(
      isPrimary = true,
      comment = "玩家id"
   )
   ...
   public void loadGotSite(String data) {
      this.gotSite = DataUtils.stringToIntSet(data);
   }

   public String saveGotSite() {
      return DataUtils.intSetToString(this.gotSite);
   }

   public void loadFinishShow(String data) {
      this.finishShow = DataUtils.stringToIntSet(data);
   }

   public String saveFinishShow() {
      return DataUtils.intSetToString(this.finishShow);
   }

   public void loadRewardIds(String data) {
      this.rewardIds = DataUtils.stringToIntSet(data);
   }

   public String saveRewardIds() {
      return DataUtils.intSetToString(this.rewardIds);
   }

   public void loadPosReward(String data) {
      this.posReward = DataUtils.stringToIntList(data);
   }

   public String savePosReward() {
      return DataUtils.intListToString(this.posReward);
   }
   ...
   public void loadSeniorRewards(String data) {
      this.seniorRewards = DataUtils.stringToInt_intMap(data);
   }

   public String saveSeniorRewards() {
      return DataUtils.int_intMapToString(this.seniorRewards);
   }

   public void loadRoundSmashNum(String data) {
      this.roundSmashNum = DataUtils.stringToInt_intMap(data);
   }

   public String saveRoundSmashNum() {
      return DataUtils.int_intMapToString(this.roundSmashNum);
   }
