...
public class FriendArrayingEntity extends ArrayingEntity {
   public HeroMirror mirror;

   public FriendArrayingEntity() {
   }

   public FriendArrayingEntity(int position, HeroDao heroDao) {
      this.positon = position;
      this.code = heroDao.code;
      this.mirror = HeroMirror.fromHeroBean(heroDao);
   }

   public FriendArrayingEntity(int position, HeroMirror heroMirror) {
      this.positon = position;
      this.code = heroMirror.code;
      this.mirror = heroMirror;
   }

   public FriendArrayingEntity(int position, Monster monster) {
      this.positon = position;
      this.code = 0;
   ...
   public CommonMsg.CodeType entityType() {
      return CommonMsg.CodeType.CODE_FRIEND;
   }
