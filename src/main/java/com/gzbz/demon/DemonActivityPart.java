...
public class DemonActivityPart extends AbstractActivityPart {
   static final Logger logger = LoggerFactory.getLogger(DemonActivityPart.class);
   @Autowired
   ...
   public void rotateReset(int oldActivityId) {
      ...
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
   ...
   @MsgHandlerAnno
   public void C2S_DemonCopyInfo_4801(DemonMsg.C2S_DemonCopyInfo_4801 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      this.demonMgr.pushTaskEx("buildCopyInfo", new Object[]{this.player, demonActivityDao});
   }

   @MsgHandlerAnno
   public void C2S_DemonBossInfo_4803(DemonMsg.C2S_DemonBossInfo_4803 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      this.demonMgr.pushTaskEx("buildBossInfo", new Object[]{this.player, demonActivityDao});
   }

   @MsgHandlerAnno
   public void C2S_LeaveBossUI_4850(DemonMsg.C2S_LeaveBossUI_4850 msg, String source) {
      this.demonMgr.pushTaskEx("leaveBossUI", new Object[]{this.player});
   }

   @MsgHandlerAnno
   public void C2S_SelectBuff_4834(DemonMsg.C2S_SelectBuff_4834 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      DemonBossDao bossDao = this.demonMgr.getBossDao();
      ...
      if (tempStage == 0) {
         DemonMsg.S2C_SelectBuff_4835.Builder builder = DemonMsg.S2C_SelectBuff_4835.newBuilder();
         builder.setBuff(0);
   ...
   @MsgHandlerAnno
   public void C2S_DelBuff_4836(DemonMsg.C2S_DelBuff_4836 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      demonActivityDao.buff = 0;
      demonActivityDao.updateOp();
      DemonMsg.S2C_DelBuff_4837.Builder builder = DemonMsg.S2C_DelBuff_4837.newBuilder();
      builder.setBuff(demonActivityDao.buff);
      this.player.sendMsg(builder.build());
   }

   @MsgHandlerAnno
   public void C2S_ReceiveBuffAward_4838(DemonMsg.C2S_ReceiveBuffAward_4838 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      ...
      if (model != null) {
         ...
         if (model.getValue() > bossDao.tokenNum) {
            ...
            demonActivityDao.updateOp();
            DemonMsg.S2C_ReceiveBuffAward_4839.Builder builder = DemonMsg.S2C_ReceiveBuffAward_4839.newBuilder();
   ...
   public DemonActivityDao getDemonActivityDao() {
      DemonActivityDao demonActivityDao = (DemonActivityDao)this.player.getData("tb_demon_activity", this.player.getPlayerId());
   ...
   public void refreshCopy(DemonActivityDao demonActivityDao) {
      DemonBossDao bossDao = this.demonMgr.getBossDao();
      int decValue = 0;
      int leftValue = 0;
      int duplicateType = 0;
   ...
   @MsgHandlerAnno
   public void C2S_BuyFightNum_4805(DemonMsg.C2S_BuyFightNum_4805 msg, String source) {
      if (!this.isServerActivityInvalid()) {
         ...
         if (demonActivityDao.buyFightNum + 1 < cost.length) {
            ...
            if (!this.player.checkResourceNum(1, PlayerDefine.PLAYER_GOLD, costNum)) {
               ...
               demonActivityDao.updateOp();
               DemonMsg.S2C_BuyFightNum_4806.Builder builder = DemonMsg.S2C_BuyFightNum_4806.newBuilder();
   ...
   public void afterFight(BattleDao battleDao) {
      ...
      demonActivityDao.updateOp();
      this.demonMgr.pushTaskEx("updateTokenNum", new Object[]{this.player, tokenNum, demonActivityDao});
      RankPart rankPart = (RankPart)this.player.getMgrPart(RankPart.class);
      int score = (int)rankPart.getScore(RankDefine.RankModule.DEMON_COPY_POINT);
      this.rankMgr.pushTaskEx("updateRankHigherEx", new Object[]{RankDefine.RankModule.DEMON_COPY_POINT, tokenNum + score, this.player.getPlayerId()});
      String award = "";
   ...
   @MsgHandlerAnno
   public void C2S_RefreshCopy_4819(DemonMsg.C2S_RefreshCopy_4819 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      ...
      this.refreshCopy(demonActivityDao);
      DemonMsg.S2C_RefreshCopy_4820.Builder builder = DemonMsg.S2C_RefreshCopy_4820.newBuilder();
   ...
   @MsgHandlerAnno
   public void C2S_CommitTask_4844(DemonMsg.C2S_CommitTask_4844 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      ...
      if (model != null) {
         ...
         if (model.getTargetNum() <= playerDao.fengmo_point) {
            if (!demonActivityDao.receiveTask.contains(msg.getTaskId())) {
               ...
               demonActivityDao.updateOp();
               DemonMsg.S2C_CommitTask_4845.Builder builder = DemonMsg.S2C_CommitTask_4845.newBuilder();
   ...
   @MsgHandlerAnno
   public void C2S_receiveBox_4826(DemonMsg.C2S_receiveBox_4826 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      DemonBossDao bossDao = this.demonMgr.getBossDao();
      if (msg.getLevel() > bossDao.bossLev) {
         ...
         if (model != null) {
            if (!model.getLevelReward().isEmpty()) {
               ...
               demonActivityDao.updateOp();
               DemonMsg.S2C_ReceiveBox_4827.Builder builder = DemonMsg.S2C_ReceiveBox_4827.newBuilder();
   ...
   @MsgHandlerAnno
   public void C2S_SelectHero_4807(DemonMsg.C2S_SelectHero_4807 msg, String source) {
            ...
            if (!HeroModel.isReplacementHero(heroDao.id)) {
               ...
               if (heroModel.getNation() != 10 || heroDao.inheritNation > 0) {
                  if (heroDao.type == HeroDefine.HERO_SP_TYPE_LINK && heroDao.linkCode <= 0) {
                     ...
                     this.demonMgr.pushTaskEx("addPoolHero", new Object[]{this.player, data});
                     ...
                     demonActivityDao.updateOp();
                     DemonMsg.S2C_SelectHero_4808.Builder builder = DemonMsg.S2C_SelectHero_4808.newBuilder();
                     builder.setResult(1);
   ...
   @MsgHandlerAnno
   public void C2S_DelHero_4809(DemonMsg.C2S_DelHero_4809 msg, String source) {
      this.demonMgr.pushTaskEx("delPoolHero", new Object[]{this.player, msg.getHeroCode()});
      DemonMsg.S2C_DelHero_4810.Builder builder = DemonMsg.S2C_DelHero_4810.newBuilder();
      builder.setResult(1);
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
   ...
   @MsgHandlerAnno
   public void C2S_SupportHero_4847(DemonMsg.C2S_SupportHero_4847 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      demonActivityDao.updateOp();
      DemonMsg.S2C_SupportHero_4848.Builder builder = DemonMsg.S2C_SupportHero_4848.newBuilder();
      builder.setRandHeroNum(demonActivityDao.randHeroNum);
      if (demonActivityDao.randHero.isEmpty() && this.demonMgr.checkBossOpen()) {
         this.demonMgr.pushTaskEx("randPoolHero", new Object[]{this.player, demonActivityDao, 1});
      } else {
   ...
   @MsgHandlerAnno
   public void C2S_RandHero_4811(DemonMsg.C2S_RandHero_4811 msg, String source) {
      if (!this.demonMgr.checkBossOpen()) {
         ...
         this.demonMgr.pushTaskEx("randPoolHero", new Object[]{this.player, demonActivityDao, 2});
      }
   }
   ...
   public void randHeroResult(List<DemonBossData> list) {
      ...
      demonActivityDao.updateOp();
      DemonMsg.S2C_RandHero_4812.Builder builder = DemonMsg.S2C_RandHero_4812.newBuilder();
      builder.setRandHeroNum(demonActivityDao.randHeroNum);
   ...
   @MsgHandlerAnno
   public void C2S_HeroPool_4828(DemonMsg.C2S_HeroPool_4828 msg, String source) {
      this.demonMgr.pushTaskEx("heroPoolInfo", new Object[]{this.player});
   }

   @MsgHandlerAnno
   public void C2S_OneHeroInfo_4830(DemonMsg.C2S_OneHeroInfo_4830 msg, String source) {
      int playerId = msg.getHeroPlayerId();
      int heroCode = msg.getHeroCode();
      this.demonMgr.pushTaskEx("oneHeroInfo", new Object[]{this.player, playerId, heroCode});
   }

   @MsgHandlerAnno
   public void C2S_ResetHero_4840(DemonMsg.C2S_ResetHero_4840 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      demonActivityDao.hitHero.clear();
      ...
      demonActivityDao.updateOp();
      DemonMsg.S2C_ResetHero_4841.Builder builder = DemonMsg.S2C_ResetHero_4841.newBuilder();
      builder.setResult(1);
      this.player.sendMsg(builder.build());
   }

   @MsgHandlerAnno
   public void C2S_RandHeroRule_4842(DemonMsg.C2S_RandHeroRule_4842 msg, String source) {
      if (msg.getRandRuleList().size() == 4) {
         ...
         demonActivityDao.updateOp();
         DemonMsg.S2C_RandHeroRule_4843.Builder builder = DemonMsg.S2C_RandHeroRule_4843.newBuilder();
   ...
   @MsgHandlerAnno
   public void C2S_SaveArraying_4813(DemonMsg.C2S_SaveArraying_4813 msg, String source) {
      if (!msg.getArrayingList().isEmpty()) {
         ...
         HeroArrayingDao heroArrayingDao = heroArrayingPart.getHeroArrayingDaoByType(CommonMsg.HeroState.HERO_STATE_DEMON_BOSS);
         int targetSoulHeroCode = 0;
         List<Integer> linkHeroList = new ArrayList();

         for(DemonMsg.Arraying arraying : msg.getArrayingList()) {
         ...
         if (!linkHeroList.isEmpty() && msg.getArrayingList().stream().anyMatch((arrayingInfo) -> {
            ...
            demonActivityDao.updateOp();
            DemonMsg.S2C_SaveArraying_4814.Builder builder = DemonMsg.S2C_SaveArraying_4814.newBuilder();
            builder.setResult(1);
   ...
   @MsgHandlerAnno
   public void C2S_SelectSoulHero_4883(DemonMsg.C2S_SelectSoulHero_4883 msg, String source) {
      HeroBagPart heroBagPart = (HeroBagPart)this.player.getMgrPart(HeroBagPart.class);
      HeroDao heroDao = heroBagPart.getHeroByCode(msg.getHeroCode());
      if (heroDao != null) {
         HeroModel heroModel = (HeroModel)this.player.getGameModelPool().getEntity("hero", heroDao.id);
         if (heroModel != null && heroModel.getNation() == 10) {
            ...
            if (heroDao.inheritNation > 0 && (heroDao.getStar() >= limitStar || heroDao.heroStarSkills.size() >= heroModel.getFieldSkillSlotId())) {
               ...
               if (flag) {
                  ...
                  demonActivityDao.updateOp();
                  DemonMsg.S2C_SelectSoulHero_4884.Builder builder = DemonMsg.S2C_SelectSoulHero_4884.newBuilder();
   ...
   @MsgHandlerAnno
   public void C2S_MyArraying_4815(DemonMsg.C2S_MyArraying_4815 msg, String source) {
      HeroBagPart heroBagPart = (HeroBagPart)this.player.getMgrPart(HeroBagPart.class);
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      DemonMsg.S2C_MyArraying_4816.Builder builder = DemonMsg.S2C_MyArraying_4816.newBuilder();
      ...
      while(it.hasNext()) {
         ...
         DemonMsg.ExtraHero.Builder heroInfo = DemonMsg.ExtraHero.newBuilder();
      ...
      demonActivityDao.updateOp();
      builder.setTokeNum(this.demonMgr.getBossDao().tokenNum);
      builder.setSoulHeroCode(demonActivityDao.soulHeroCode);
      this.player.sendMsg(builder.build());
   }

   @MsgHandlerAnno
   public void C2S_HitOneHero_4832(DemonMsg.C2S_HitOneHero_4832 msg, String source) {
      if (!this.demonMgr.checkBossOpen()) {
         this.player.failure(61079);
      } else {
         ...
         if (demonActivityDao.hitHero.size() < 2) {
            ...
            demonActivityDao.updateOp();
            DemonMsg.S2C_HitOneHero_4833.Builder builder = DemonMsg.S2C_HitOneHero_4833.newBuilder();
            builder.setResult(1);
   ...
   public int enterBossBattle(BattleDao battleDao) {
      if (this.isServerActivityInvalid()) {
         return 61070;
      } else if (!this.demonMgr.checkBossOpen()) {
         return 61077;
      } else {
   ...
   public int getStaticBuff(DemonBossDao bossDao, int type) {
      int addValue = 0;
   ...
   public PropertyModel getStaticDamageBuff(DemonBossDao bossDao, int type) {
      int addValue = 0;
      List<Integer> buffList = new ArrayList();
      int temp = 0;
      Map<Integer, FengmoBuffModel> buffMap = this.player.getGameModelPool().getMap("FengmoBuff");
   ...
   public FengmoFixedBuffModel getStaticRate(DemonBossDao bossDao, int type) {
   ...
   public void afterBossFight(BattleDao battleDao) {
      ...
      demonActivityDao.updateOp();
      this.demonMgr.pushTaskEx("fightBoss", new Object[]{this.player, demonActivityDao, damage});
   ...
   @MsgHandlerAnno
   public void C2S_TreasureInfo_4861(DemonMsg.C2S_TreasureInfo_4861 msg, String source) {
      if (!this.isServerActivityInvalid()) {
   ...
   private void sendTreasureInfo() {
      DemonMsg.S2C_TreasureInfo_4862.Builder builder = DemonMsg.S2C_TreasureInfo_4862.newBuilder();
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      ...
      builder.addAllEnjoyIds(this.getDemonActivityDao().enjoyIds);
      this.player.sendMsg(builder.build());
   }

   @MsgHandlerAnno
   public void C2S_Enjoy_4863(DemonMsg.C2S_Enjoy_4863 msg, String source) {
      if (!this.isServerActivityInvalid()) {
         DemonActivityDao demonActivityDao = this.getDemonActivityDao();
         if (demonActivityDao.jackpot.size() != 0) {
            ...
            if (modelList == null) {
               ...
               if (groupMap.size() != groupSet.size()) {
                  ...
                  demonActivityDao.updateOp();
                  DemonMsg.S2C_Enjoy_4864.Builder builder = DemonMsg.S2C_Enjoy_4864.newBuilder();
   ...
   @MsgHandlerAnno
   public void C2S_Draw_4865(DemonMsg.C2S_Draw_4865 msg, String source) {
      if (!this.isServerActivityInvalid()) {
         DemonActivityDao demonActivityDao = this.getDemonActivityDao();
         if (demonActivityDao.jackpot.size() == 0) {
                  ...
                  if (modelList != null && modelList.size() != 0) {
                     ...
                     if (!this.player.checkResourceNum(materialList)) {
                        ...
                        if (rewardSet.size() != count) {
                           ...
                           DemonMsg.S2C_Draw_4866.Builder builder = DemonMsg.S2C_Draw_4866.newBuilder();
   ...
   private void turnToNextWheel(DemonActivityDao demonActivityDao) {
   ...
   @MsgHandlerAnno
   public void C2S_DestinyInfo_4869(DemonMsg.C2S_DestinyInfo_4869 msg, String source) {
      this.sendDestinyInfo();
   }

   private void sendDestinyInfo() {
      if (!this.isServerActivityInvalid()) {
         DemonMsg.S2C_DestinyInfo_4870.Builder builder = DemonMsg.S2C_DestinyInfo_4870.newBuilder();
         DemonActivityDao demonActivityDao = this.getDemonActivityDao();
   ...
   @MsgHandlerAnno
   public void C2S_DestinyDraw_4871(DemonMsg.C2S_DestinyDraw_4871 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
         ...
         if (CollectionUtils.isEmpty(modelMap)) {
            ...
            if (CollectionUtils.isEmpty(models)) {
               ...
               if (funList.size() == 0) {
                  ...
                  DemonMsg.S2C_DestinyDraw_4872.Builder builder = DemonMsg.S2C_DestinyDraw_4872.newBuilder();
                  builder.setId(id);
                  this.player.sendMsg(builder.build());
               }
            }
   ...
   public void recordActive(int value) {
      if (!this.isServerActivityInvalid()) {
         ...
         demonActivityDao.updateOp();
         DemonMsg.S2C_UpdateActive_4880.Builder builder = DemonMsg.S2C_UpdateActive_4880.newBuilder();
         builder.setActive(demonActivityDao.active);
         this.player.sendMsg(builder.build());
      }
   }
   ...
   @MsgHandlerAnno
   public void C2S_DestinyBox_4873(DemonMsg.C2S_DestinyBox_4873 msg, String source) {
      if (!this.isServerActivityInvalid()) {
         DemonActivityDao demonActivityDao = this.getDemonActivityDao();
         if (demonActivityDao.destinyBox) {
            ...
            if (demonActivityDao.active < Integer.parseInt(strArr[0])) {
               ...
               DemonMsg.S2C_DestinyBox_4874.Builder builder = DemonMsg.S2C_DestinyBox_4874.newBuilder();
               this.player.sendMsg(builder.build());
            }
         }
      }
   ...
   @MsgHandlerAnno
   public void C2S_TimeRewards_4875(DemonMsg.C2S_TimeRewards_4875 msg, String source) {
      ...
      if (CollectionUtils.isEmpty(modelMap)) {
         ...
         if (demonActivityDao.timeRewards.contains(model.getDrawTime())) {
            ...
            DemonMsg.S2C_TimeRewards_4876.Builder builder = DemonMsg.S2C_TimeRewards_4876.newBuilder();
   ...
   @MsgHandlerAnno
   public void C2S_Refresh_4877(DemonMsg.C2S_Refresh_4877 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      ...
      if (demonActivityDao.refreshReward >= resourceModels.size()) {
         ...
         if (!this.player.checkResourceNum(resourceModel)) {
            ...
            this.turnToNextWheel(demonActivityDao);
            demonActivityDao.updateOp();
            DemonMsg.S2C_Refresh_4878.Builder builder = DemonMsg.S2C_Refresh_4878.newBuilder();
            builder.setWheel(this.getCurWheel(demonActivityDao.wheel));
            builder.setRefreshReward(demonActivityDao.refreshReward);
            this.player.sendMsg(builder.build());
         }
   ...
   @MsgHandlerAnno
   public void C2S_DrawRecord_4881(DemonMsg.C2S_DrawRecord_4881 msg, String source) {
      DemonActivityDao demonActivityDao = this.getDemonActivityDao();
      DemonMsg.S2C_DrawRecord_4882.Builder builder = DemonMsg.S2C_DrawRecord_4882.newBuilder();
