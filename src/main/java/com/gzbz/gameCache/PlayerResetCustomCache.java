...
public class PlayerResetCustomCache extends CustomCacheData<PlayerResetDao> {
    ...
    public static Map<Class<?>, BiFunction<?, ?, ?>> sumFunc = new HashMap<>();
    ...
    static {
        ...
        sumFunc.put(Byte.class, (Byte a, Byte b) -> (byte) (a + b));
        sumFunc.put(byte.class, (Byte a, Byte b) -> (byte) (a + b));

        sumFunc.put(Short.class, (Short a, Short b) -> (short) (a + b));
        sumFunc.put(short.class, (Short a, Short b) -> (short) (a + b));

        sumFunc.put(Long.class, (Long a, Long b) -> a + b);
        sumFunc.put(long.class, (Long a, Long b) -> a + b);
    }
}
